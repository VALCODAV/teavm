    ...
    static void parseResult(Scriptable result, TestRunCallback callback, File debugFile) {
        ...
        switch (status) {
            ...
            case "exception": {
                ...
                sb.append(parseStack(stack, script, debugInformation));
                callback.error(new AssertionError(sb.toString()));
                break;
            }
        }
    }

    private static String parseStack(String stack, String[] script, DebugInformation debugInformation) {
        StringBuilder sb = new StringBuilder();
        for (String line : lineSeparator.split(stack)) {
            ...
            if (location != null && location.getFileName() != null) {
                ...
                sb.append("test.js:").append(lineNumber);
            }
            sb.append(")");
        }
